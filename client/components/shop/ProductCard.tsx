      ...
      <div className="p-4 flex flex-col h-full">
        ...
        <div className="mt-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            <a href={link} target="_blank" rel="noreferrer" className="inline-flex items-center rounded-lg bg-blue-600 px-3 py-1.5 text-xs md:text-sm font-semibold text-white shadow shadow-blue-500/20 transition-all duration-300 hover:shadow-glow whitespace-nowrap min-w-[88px] md:min-w-[110px]">
              Buy Now
            </a>
          </div>
        </div>
